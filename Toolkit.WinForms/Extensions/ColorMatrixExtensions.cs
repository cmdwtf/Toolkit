...
namespace cmdwtf.Toolkit.WinForms.Extensions
{
	...
	public static class ColorMatrixExtensions
	{
		...
		public static void SetTintColorMatrix(this ImageAttributes attribs, Color tintColor)
			=> attribs.SetColorMatrix(tintColor.CreateTintColorMatrix());
		...
		public static void SetHueColorMatrix(this ImageAttributes attribs, Color hueColor, float intensity = 1.0f)
			=> attribs.SetColorMatrix(hueColor.CreateHueColorMatrix(intensity));
		...
		public static SdiColorMatrix CreateHueColorMatrix(this Color hueColor, float intensity = 1.0f)
		{
		...
		public static SdiColorMatrix CreateTintColorMatrix(this Color tintBy)
		{
