...
{
	/// <summary>
	/// Native methods, constants, and structs for Window operations.
	...
	internal static class Windows
	{
		...
		public enum WM : uint
		{
			...
			KILLFOCUS = 0x0008,
			/// <summary>
			/// The WM_ENABLE message is sent when an application changes the enabled state of a window. It is sent to the window whose enabled state is changing. This message is sent before the EnableWindow function returns, but after the enabled state (DISABLED style bit) of the window has changed.
			/// </summary>
			ENABLE = 0x000A,
			/// <summary>
		...
		public static class WS
		{
			...
			public const int CLIPCHILDREN = 0x2000000;
			...
			/// </summary>
			public const int CLIPSIBLINGS = 0x4000000;

			/// <summary>The window is initially disabled. A disabled window cannot receive input from the user. To change this after a window has been created, use the EnableWindow function.</summary>
			public const int DISABLED = 0x8000000;

			/// <summary>The window has a border of a style typically used with dialog boxes. A window with this style cannot have a title bar.</summary>
			public const int DLGFRAME = 0x400000;
			...
			/// </summary>
			public const int GROUP = 0x20000;

			/// <summary>The window has a horizontal scroll bar.</summary>
			public const int HSCROLL = 0x100000;

			/// <summary>The window is initially maximized.</summary>
			public const int MAXIMIZE = 0x1000000;
			...
			public const int OVERLAPPED = 0x0;

			/// <summary>The window is an overlapped window.</summary>
			public const int OVERLAPPEDWINDOW = OVERLAPPED | CAPTION | SYSMENU | SIZEFRAME | MINIMIZEBOX | MAXIMIZEBOX;

			/// <summary>The window is a pop-up window. This style cannot be used with the CHILD style.</summary>
			public const int POPUP = unchecked((int)(0x80000000u));
			...
			public const int SIZEFRAME = 0x40000;
			...
			public static class EX
			{
				...
				public const int WINDOWEDGE = 0x0000010;
			}
		}
